>E' possibile che nella nostra istanza di relazione, non tutte le tuple abbiano tutti i dati, quando questo avviene si utilizza un valore speciale per indicare che *il dato non e' presente*, il valore **NULL**.
